    ...
    <Card>
      ...
      <CardContent>
        <Stack divider={<Divider />} spacing={3}>
          ...
          >
            <Summary icon={ChartPieIcon} title="Anzahl Messungen" value={16400} />
            <Summary icon={ReceiptIcon} title="Anzahl ESPs" value={13} />
            <Summary icon={ClockIcon} title="Messungen pro Tag" value={1200} />
          </Stack>
          <NoSsr fallback={<Box sx={{ height: `${chartHeight}px` }} />}>
            <ResponsiveContainer height={chartHeight} width="100%">
              <LineChart data={data} margin={{ top: 0, right: 20, bottom: 0, left: 20 }}>
                ...
                <YAxis axisLine={false} domain={[0, 40]} hide type="number" yAxisId={0} />
                <YAxis axisLine={false} domain={[0, 40]} hide type="number" yAxisId={1} />
                {lines.map(
