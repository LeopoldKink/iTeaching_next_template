...
export interface BalkenDiagrammProps {
  data: { name: string; v1: number; v2: number }[];
}

export function BalkenDiagramm({ data }: BalkenDiagrammProps): React.JSX.Element {
          ...
          <Stack spacing={3} sx={{ flex: '0 0 auto', justifyContent: 'space-between', width: '240px' }}>
            ...
            <div>
              <Typography color="text.secondary" variant="body2">
                ...
                ist also wärmer als letzter Monat.
                </Typography>
            </div>
          </Stack>
